...
//Light intensity for batman obj
Keytimes Lint;
...
Display( )
{
	...
	gluLookAt(Xpos_C.GetValue(nowTime), 2.f, 3, Xpos.GetValue(nowTime), 2, Ypos_C.GetValue(nowTime), 0.f, 1.f, 0.f);
...
InitGraphics( )
{
	...
	for (int i = 0; i < 5; i++) {
		Xpos.AddTimeValue((10. * ((float)i / 5.)), sin((F_2_PI * ((float)i / 5))));
		Yrot_b.AddTimeValue((10. * ((float)i / 5.)), tan((F_2_PI * ((float)i / 5))) * 360);
		Zpos.AddTimeValue((10. * ((float)i / 5.)), cos((F_2_PI * ((float)i / 5))));

		Xrot_L.AddTimeValue((10. * ((float)i / 5.)), (sin(((F_2_PI * ((float)i / 5)))) + 1) * 3);

		Lint.AddTimeValue((10. * ((float)i / 5.)), tan((F_2_PI * ((float)i / 5))));
	...
	Zpos.AddTimeValue(10.0, 1.000);
	Xrot_L.AddTimeValue(10.0, 0.000);
	Lint.AddTimeValue(10.0, 0.000);
