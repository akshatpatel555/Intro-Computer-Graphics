...
Display( )
{
	...
	/*float lightPosX = sin(10 * F_2_PI * Time);
	float lightPosY = cos(10 * F_2_PI * Time);
	float lightPosZ = 10;*/

	float radius = 5.0;  // Define a radius for the rotation
	float lightPosX = radius * cos(F_2_PI * Time);
	float lightPosY = 10.0;   // Fixed height above the models
	float lightPosZ = radius * sin(F_2_PI * Time);
